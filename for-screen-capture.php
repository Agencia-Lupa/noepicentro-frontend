  ...
  <body>
    ...
    >
      ...
      <div class="main">
        ...
        <nav>
          <span class="button"><span class="screen-reader">Versão em </span>Português</span>
          <a class="button" rel="alternate" href="en/" hreflang="en" lang="en">English<span class="screen-reader"> version</span></a>
        </nav>
            ...
            <div class="steps">
              ...
              <div class="swiper-container">
                ...
                <div class="swiper-wrapper">
                  ...
                  <div data-step="Zoom in" class="swiper-slide"></div>
                  <div data-step="Zoom out fast" class="swiper-slide"></div>
                  <div data-step="Zoom in" class="swiper-slide"></div>
                  <div data-step="Zoom out slow" class="swiper-slide"></div>

                  <!--
                  http://vinicius.local/www/coldfoot/front/for-screen-capture?deaths=100000&center=[-43.230156,-22.912109]
                  http://vinicius.local/www/coldfoot/front/for-screen-capture?deaths=100000&center=[-46.655910,-23.561444]
                  http://vinicius.local/www/coldfoot/front/for-screen-capture?deaths=100000&center=[-49.2675855,-25.4251957]
                  http://vinicius.local/www/coldfoot/front/for-screen-capture?deaths=100000&center=[-38.504670, -12.984521]
                  http://vinicius.local/www/coldfoot/front/for-screen-capture?deaths=100000&center=[-48.480996, -1.452692]
                  -->

                  <!-- <div data-step="Maracanã Zoom In" class="swiper-slide"></div>
                  <div data-step="Maracanã Zoom Out" class="swiper-slide"></div> -->
                  <!-- -43.230156,-22.912109 -->

                  <!-- <div data-step="MASP Zoom In" class="swiper-slide"></div>
                  <div data-step="MASP Zoom Out" class="swiper-slide"></div> -->
                  <!-- -46.655910,-23.561444 -->

                  <!-- <div data-step="Passeio Público Zoom In" class="swiper-slide"></div>
                  <div data-step="Passeio Público Zoom Out" class="swiper-slide"></div> -->
                  <!-- -49.2675855,-25.4251957 -->

                  <!-- <div data-step="Dique do Tororó Zoom In" class="swiper-slide"></div>
                  <div data-step="Dique do Tororó Zoom Out" class="swiper-slide"></div> -->
                  <!-- -38.504670, -12.984521 -->

                  <!-- <div data-step="Basílica Santuário Zoom In" class="swiper-slide"></div>
                  <div data-step="Basílica Santuário Zoom Out" class="swiper-slide"></div> -->
                  <!-- -48.480996, -1.452692 -->
    ...
    <script src="script/app-for-screen-capture.js?v=1.2.3"></script>
