...
},{"@turf/helpers":9}],3:[function(require,module,exports){
...
},{"@turf/invariant":10}],5:[function(require,module,exports){
...
},{"@turf/area":1,"@turf/helpers":9,"@turf/invariant":10,"@turf/meta":12,"turf-jsts":18}],8:[function(require,module,exports){
...
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function mask(e,n){var r=createMask(n),t=separatePolygons(e),o=t[0],u=t[1];return o=unionPolygons(o),u=unionPolygons(u),buildMask(r,o,u)}function buildMask(e,n,r){var t=[];return t.push(e.geometry.coordinates[0]),meta.flattenEach(n,function(e){t.push(e.geometry.coordinates[0])}),meta.flattenEach(r,function(e){t.push(e.geometry.coordinates[0])}),helpers.polygon(t)}function separatePolygons(e){var n=[],r=[];return meta.flattenEach(e,function(e){var t=e.geometry.coordinates,o=t[0],u=t.slice(1);n.push(helpers.polygon([o])),u.forEach(function(e){r.push(helpers.polygon([e]))})}),[helpers.featureCollection(n),helpers.featureCollection(r)]}function createMask(e){var n=[[[180,90],[-180,90],[-180,-90],[180,-90],[180,90]]],r=e&&e.geometry.coordinates||n;return helpers.polygon(r)}function unionPolygons(e){if(e.features.length<=1)return e;var n=createIndex(e),r=[],t={};return meta.flattenEach(e,function(e,o){if(t[o])return!0;for(n.remove({index:o},filterByIndex),t[o]=!0;;){var u=turfBBox(e),a=n.search({minX:u[0],minY:u[1],maxX:u[2],maxY:u[3]});if(a.length>0){var i=a.map(function(e){return t[e.index]=!0,n.remove({index:e.index},filterByIndex),e.geojson});i.push(e),e=union.apply(this,i)}if(0===a.length)break}r.push(e)}),helpers.featureCollection(r)}function filterByIndex(e,n){return e.index===n.index}function createIndex(e){var n=rbush(),r=[];return meta.flattenEach(e,function(e,n){var t=turfBBox(e);r.push({minX:t[0],minY:t[1],maxX:t[2],maxY:t[3],geojson:e,index:n})}),n.load(r),n}var rbush=_interopDefault(require("rbush")),union=_interopDefault(require("@turf/union")),helpers=require("@turf/helpers"),turfBBox=_interopDefault(require("@turf/bbox")),meta=require("@turf/meta");module.exports=mask,module.exports.default=mask;

},{"@turf/bbox":3,"@turf/helpers":9,"@turf/meta":12,"@turf/union":15,"rbush":17}],12:[function(require,module,exports){
...
},{"@turf/boolean-point-in-polygon":4,"@turf/helpers":9,"@turf/meta":12}],14:[function(require,module,exports){
"use strict";function randomPosition(r){if(helpers.isObject(r)&&(r=r.bbox),r&&!Array.isArray(r))throw new Error("bbox is invalid");return r?coordInBBox(r):[lon(),lat()]}function randomPoint(r,n){if(n=n||{},!helpers.isObject(n))throw new Error("options is invalid");var o=n.bbox;void 0!==r&&null!==r||(r=1);for(var e=[],t=0;t<r;t++)e.push(helpers.point(randomPosition(o)));return helpers.featureCollection(e)}function randomPolygon(r,n){function o(r,n,o){o[n]=n>0?r+o[n-1]:r}function e(r){r=2*r*Math.PI/u[u.length-1];var n=Math.random();h.push([n*a*Math.sin(r),n*a*Math.cos(r)])}if(n=n||{},!helpers.isObject(n))throw new Error("options is invalid");var t=n.bbox,i=n.num_vertices,a=n.max_radial_length;void 0!==r&&null!==r||(r=1),helpers.isNumber(i)||(i=10),helpers.isNumber(a)||(a=10);for(var s=[],l=0;l<r;l++){var h=[],u=Array.apply(null,new Array(i+1)).map(Math.random);u.forEach(o),u.forEach(e),h[h.length-1]=h[0],h=h.map(vertexToCoordinate(randomPosition(t))),s.push(helpers.polygon([h]))}return helpers.featureCollection(s)}function randomLineString(r,n){if(n=n||{},!helpers.isObject(n))throw new Error("options is invalid");var o=n.bbox,e=n.num_vertices,t=n.max_length,i=n.max_rotation;void 0!==r&&null!==r||(r=1),(!helpers.isNumber(e)||e<2)&&(e=10),helpers.isNumber(t)||(t=1e-4),helpers.isNumber(i)||(i=Math.PI/8);for(var a=[],s=0;s<r;s++){for(var l=randomPosition(o),h=[l],u=0;u<e-1;u++){var d=0===u?2*Math.random()*Math.PI:Math.tan((h[u][1]-h[u-1][1])/(h[u][0]-h[u-1][0])),p=d+(Math.random()-.5)*i*2,m=Math.random()*t;h.push([h[u][0]+m*Math.cos(p),h[u][1]+m*Math.sin(p)])}a.push(helpers.lineString(h))}return helpers.featureCollection(a)}function vertexToCoordinate(r){return function(n){return[n[0]+r[0],n[1]+r[1]]}}function rnd(){return Math.random()-.5}function lon(){return 360*rnd()}function lat(){return 180*rnd()}function coordInBBox(r){return[Math.random()*(r[2]-r[0])+r[0],Math.random()*(r[3]-r[1])+r[1]]}Object.defineProperty(exports,"__esModule",{value:!0});var helpers=require("@turf/helpers");exports.randomPosition=randomPosition,exports.randomPoint=randomPoint,exports.randomPolygon=randomPolygon,exports.randomLineString=randomLineString;

},{"@turf/helpers":9}],15:[function(require,module,exports){
...
},{"turf-jsts":18}],16:[function(require,module,exports){
...
module.exports={bbox:require("@turf/bbox"),bboxPolygon:require("@turf/bbox-polygon"),circle:require("@turf/circle"),helpers:require("@turf/helpers"),distance:require("@turf/distance"),difference:require("@turf/difference"),mask:require("@turf/mask"),union:require("@turf/union"),random:require("@turf/random"),pointsWithinPolygon:require("@turf/points-within-polygon")};
},{"@turf/bbox":3,"@turf/bbox-polygon":2,"@turf/circle":5,"@turf/difference":7,"@turf/distance":8,"@turf/helpers":9,"@turf/mask":11,"@turf/points-within-polygon":13,"@turf/random":14,"@turf/union":15}]},{},[19])(19)
});
