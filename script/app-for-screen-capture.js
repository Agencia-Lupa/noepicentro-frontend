...
let app = {
  ...
  parameters : {
    ...
    initialize : function() {
      ...
      for ( let parameter of [ 'center', 'minimal' ] ) {

        if ( parameters.has( parameter ) ) {

          let value = JSON.parse( parameters.get( parameter ) )
          app.parameters[ parameter ] = value
          document.documentElement.dataset[ parameter ] = value
